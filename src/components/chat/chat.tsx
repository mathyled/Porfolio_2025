  ...
  return (
    <div className="relative h-screen overflow-hidden bg-background bg-[linear-gradient(to_right,#8080801a_1px,transparent_1px),linear-gradient(to_bottom,#8080801a_1px,transparent_1px)] bg-[size:64px_64px]">
      <div className="mx-auto flex h-full max-w-[1400px] flex-col lg:flex-row">
          ...
          <div className={`transition-all duration-300 ease-in-out ${hasActiveTool ? 'pt-6 pb-0' : 'py-6'}`}>
            ...
            <AnimatePresence>
              {latestUserMessage && !currentAIMessage && (
                <motion.div {...MOTION_CONFIG} className="mx-auto flex px-4">
        ...
        {/* ======================================================= */}
        <div className="hidden lg:flex lg:w-80 xl:w-96 flex-col border-r border-border/50 bg-background/50 backdrop-blur-md p-6 h-full relative z-20">
          <div className="flex flex-col items-center pt-8 mb-8 shrink-0">
            <ClientOnly>
          ...
          <div className="mt-auto flex flex-col gap-4 w-full">
            ...
            />
            <div className="bg-background/80 rounded-2xl shadow-sm border border-border/50 p-2">
              <ChatBottombar
                input={input}
        ...
        <div className="flex-1 flex flex-col h-full relative w-full lg:max-w-4xl xl:max-w-5xl mx-auto">
          ...
          >
            <AnimatePresence mode="wait">
              {isEmptyState ? (
                <motion.div
                  key="landing"
                  className="flex min-h-full items-center justify-center pt-8 lg:pt-0"
                  {...MOTION_CONFIG}
                >
                  <ChatLanding
                    submitQuery={submitQuery}
          ...
          {/* ======================================================= */}
          <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-md px-2 pt-3 pb-4 border-t border-border/50">
